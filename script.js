...
function showItem() {
  ...
  headerImge.src = "./images/111.jpg";
  headerContent.appendChild(headerImge);
  const userName = document.createElement("div");
  userName.className = "userName";
  userName.textContent = "@mughessib96";
...
window.addEventListener("load", () => {
    ...
    let show = arrItems.map(e => {
      ...
      iconsRetweet.innerHTML = "<i class='fa-solid fa-retweet'></i>";
        ...
        iconsRetweet.addEventListener('click', () => {
            ...
            const iconsCommentRe = document.createElement("i");
            iconsCommentRe.innerHTML = "<i class='fa-regular fa-comment'></i>";
    fotterDivRe.appendChild(iconsCommentRe);
        })
        //end function 
        const iconsHeart = document.createElement("i");
        iconsHeart.innerHTML = "<i class='fa-solid fa-heart'></i>";
    ...
    const iconsComment = document.createElement("i");
    iconsComment.innerHTML = "<i class='fa-regular fa-comment'></i>";
    fotterDiv.appendChild(iconsComment);
    })
}
});